/**
 * Compile-Time Type Checker for Expression Compatibility
 *
 * This module provides the main CompileTimeTypeChecker class that validates
 * JavaScript expressions at compile time before they are converted to CEL.
 */

import type { KubernetesRef } from '../../types/common.js';
import { CompileTimeError, CompileTimeWarning } from './compile-time-errors.js';
import type {
  CompileTimeTypeInfo,
