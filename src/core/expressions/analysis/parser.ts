...
import { DEFAULT_PARSER_OPTIONS, ParserError, parseScriptCore } from './parse-core.js';

// Re-export for backward compatibility — consumers import these from parser
export { DEFAULT_PARSER_OPTIONS, ParserError };
...
export function parseScript(source: string, options?: ParseOptions): ESTreeNode {
  ensureFnToStringValidated();
  return parseScriptCore(source, options);
}
