...
| 9 | Enforce one supported Effect v4 dependency cohort in package and lockfile tests. | Implemented for rc.110 across core, Bun platform, node-shared platform, and test packages, with Alchemy runtime coverage, a lockfile assertion, and packed Node/Bun import budgets. |
