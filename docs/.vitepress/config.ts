        ...
        '/guide/': [
          {
            ...
            items: [
              ...
              { text: 'Aspects', link: '/guide/aspects' },
        ...
        '/examples/': [
          {
            ...
            items: [
              ...
              { text: 'Collections & forEach', link: '/examples/collections' },
        ...
        '/advanced/': [
          {
            ...
            items: [
              ...
              { text: 'Integration Skill', link: '/advanced/integration-skill' },
            ],
          },
        ],
      },
