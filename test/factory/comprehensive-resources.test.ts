...
import {
  clusterRole,
  clusterRoleBinding, // Apps resources
  daemonSet,
  endpointSlice, // Networking resources
  endpoints,
  limitRange,
  namespace,
  persistentVolume, // Core resources
  pod, // Policy resources
  podDisruptionBudget,
  replicaSet,
  resourceQuota, // RBAC resources
  role,
  roleBinding,
  serviceAccount, // Storage resources
  storageClass,
} from '../../src/index';
