...
} from '../../src/core/runtime-patches/minimal-connection-reset-suppression.js';
...
describe('Minimal Connection Reset Suppression', () => {
  it('should not hang when suppressing connection resets', async () => {
    ...
    const result = await withMinimalConnectionResetSuppression(async () => {
      // Simulate some work
  ...
  it('should only patch console.error and restore it properly', async () => {
    ...
    await withMinimalConnectionResetSuppression(async () => {
