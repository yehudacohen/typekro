...
} from '../../src/core/runtime-patches/scoped-error-suppression.js';
...
describe('Scoped Connection Reset Suppression', () => {
  it('should not hang when suppressing connection resets', async () => {
    ...
    const result = await withConnectionResetSuppression(async () => {
      // Simulate some work
  ...
  it('should properly restore console methods after operation', async () => {
    ...
    await withConnectionResetSuppression(async () => {
