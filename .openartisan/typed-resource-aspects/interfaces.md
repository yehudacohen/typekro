...
export interface AspectDefinition<TTarget = AspectTarget, TSurface = AspectSurface> {
...
/** All resources that advertise a writable override schema at runtime. */
export declare const resources: AspectTargetGroup<'resources'>;
/** Backward-compatible workload-focused alias for schema-capable resource overrides. */
